...
import heroVideo from '../assets/finalTriClips.mp4'
...
const homeFaqs = [
  ...
  { q: 'When and where is the next clinic?', a: 'Our next clinic is June 6, 2026 at Lake Elizabeth Park, Fremont. Beginner runs 12–1 PM, Intermediate 1:30–3 PM, and Advanced 3:30–5 PM. Future clinics will also be held at Willow Park in Union City and Fallon\'s Park in Dublin.' },
]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="text-slate-500 text-xs mb-5">{plan.time} · June 6, 2026</p>
