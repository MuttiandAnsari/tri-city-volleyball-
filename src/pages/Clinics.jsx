...
const clinics = [
  { id: 1, title: 'Beginner Fundamentals', level: 'Beginner', grades: 'K–4', date: 'June 13, 2026', time: '12:00 – 1:00 PM', location: 'Lake Elizabeth, Fremont', spots: 8, maxSpots: 8, price: '$10 / session', description: 'The perfect first step. Athletes learn passing, serving, and court awareness in a fun, zero-pressure environment.', skills: ['Passing', 'Serving', 'Court Movement', 'Team Play'], accent: 'border-emerald-500', badge: 'bg-emerald-500', bar: 'bg-emerald-500' },
  { id: 2, title: 'Intermediate Skills', level: 'Intermediate', grades: '5–7', date: 'June 13, 2026', time: '1:30 – 3:00 PM', location: 'Lake Elizabeth, Fremont', spots: 10, maxSpots: 10, price: '$15 / session', description: 'Build on the basics with consistent setting, attacking, and defensive positioning. For players with at least one season of experience.', skills: ['Setting', 'Attacking', 'Defense', 'Serve Receive'], accent: 'border-amber-500', badge: 'bg-amber-500', bar: 'bg-amber-500' },
  { id: 3, title: 'Advanced Competitive', level: 'Advanced', grades: '8–12', date: 'June 13, 2026', time: '3:30 – 5:00 PM', location: 'Lake Elizabeth, Fremont', spots: 12, maxSpots: 12, price: '$15 / session', description: 'High-intensity training for experienced players. Sharpen competitive skills, game IQ, and tournament readiness.', skills: ['Game Strategy', 'Competitive Serving', 'Block & Attack', 'Film Review'], accent: 'border-rose-500', badge: 'bg-rose-500', bar: 'bg-rose-500' },
